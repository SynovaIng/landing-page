  ...
  return (
    <div className="min-h-screen bg-background-light flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-secondary/5 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="material-symbols-outlined text-6xl text-navy/5">
              bolt
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link
            href="/contacto"
            className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-sm border-2 border-secondary text-secondary font-bold text-base hover:bg-secondary/5 transition-all duration-300"
          >
            Contactar soporte
          </Link>
        </div>
