    ...
    <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        <div className="relative mb-6">
          <span className="text-[10rem] lg:text-[14rem] font-black leading-none text-transparent bg-clip-text bg-gradient-to-br from-[#1A3A8F] to-[#00C8E0] select-none">
            404
          </span>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-sm bg-gradient-to-r from-[#1A3A8F] to-[#00C8E0] text-white font-bold text-base shadow-lg hover:brightness-110 hover:-translate-y-0.5 transition-all duration-300"
          >
